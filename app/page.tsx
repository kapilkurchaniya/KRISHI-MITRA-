      ...
      <header className="sticky top-0 z-30 border-b border-border bg-card/85 backdrop-blur safe-area-top">
        <div className="mx-auto max-w-md flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center gap-2">
            <Link href="/login" className="px-4 py-2 text-sm font-medium rounded-lg hover:bg-muted transition-colors">
              Sign in
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-md px-4 py-8 flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 pt-2">
            <Link href="/login" className="inline-flex w-full sm:w-auto items-center justify-center rounded-full bg-primary text-primary-foreground px-6 py-3.5 text-sm font-semibold hover:opacity-90 transition-opacity">
              Get started
            </Link>
            <InstallButton />
          </div>
        ...
        <div className="flex flex-col gap-4 pt-4 border-t border-border">
          <div className="flex gap-4 justify-center">
            <Link href="/login" className="flex items-center justify-center gap-2 rounded-lg bg-primary text-primary-foreground px-5 py-3 text-sm font-semibold hover:opacity-90 transition-opacity w-full">
              Create account
