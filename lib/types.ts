...
export type Scan = {
  ...
  severity: "healthy" | "mild" | "moderate" | "severe" | "low" | "medium" | "high" | null
  summary?: string | null
...
export type MandiDetail = MandiPrice & {
  minPrice: number
  maxPrice: number
  modalPrice: number
  changePct: number
  cropMeta: (typeof import("./mandi").CROP_CATALOG)[number] | null
  history: Array<{
    date: string
    price: number
  }>
...
export type IrrigationPlan = {
  ...
  days: Array<{
    date: string
    action: "irrigate" | "skip-rain" | "monitor"
    note: string
